...
| H1.S1.M2 | Ejecutar gates estáticos y tests del foco | [gates-locales.md](evidencia/gates-locales.md) | lint focal `0`; `typecheck` exit `0`; 7 archivos y 73 tests focales pasan. |
...
- Lint global: 243 errores preexistentes de `@angular-eslint/prefer-on-push-component-change-detection`, con cero en los focos `cotizaciones` y `directory`.
