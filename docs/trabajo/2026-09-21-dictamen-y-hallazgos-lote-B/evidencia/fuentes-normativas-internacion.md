...
> [!note] Copia de coordinación
> El original vive en el repo de producto, en
> `mantra-core-health/docs/trabajo/2026-09-20-notas-cuadricula-e-internacion/evidencia/`, entregado
> en el **[PR #558](https://github.com/mdavila-2001/mantra-core-health/pull/558)**. Ahí está además
> lo **ejecutable** que acá no se copió: las capturas por ancho y tema, las salidas de las corridas
> y el triaje de la regresión.
>
> Se copia porque es análisis de coordinación y ahí nadie lo lee. Si hay que editarlo, **editá los
> dos** o la copia miente.
