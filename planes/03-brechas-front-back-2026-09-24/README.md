...
Desde la raíz del workspace, con los dos repos al día y este repo
(`AlovidaPromptManager`) clonado al lado:

```bash
INV=AlovidaPromptManager/planes/03-brechas-front-back-2026-09-24/inventarios
node $INV/extraer-rutas-api.js     mantra-core-health-redesa-api <carpeta-salida>   # api-routes.json
node $INV/cruzar-llamadas-front.js mantra-core-health <carpeta-salida>              # client-calls.json
node $INV/cruzar-mock.js           mantra-core-health <carpeta-salida>              # mock-missing.json + api-unused.json
(cd mantra-core-health-redesa-api && node ../$INV/controladores-sin-registrar.js)
```
