...
> **AVANCE: 46 / 201 microtareas — 22,9 %.** ← `microtareas HECHO / total` (M5 15 + M3 15 + M4 16).
> La **Ola 0 ya está ejecutada** y medida (`RUNS`), aparte de esas 95.
> M1 0/22 · M2 0/17 · **M3 15/15** (`TESTED`, PR #473 mergeado en `test`) · **M4 16/16** (`VERIFIED` en runtime local, 21/21; PRs #470 · #471 · #472 mergeados en `test`, #476 abierto) · **M5 15/15** (`VERIFIED`, #711 mergeado en `test` · #714 abierto, mergeable) · M6 0/15 · M7 0/101.
...
| **M4** Dell Inspiron 2 | [Agenda, farmacia, cotizaciones y contabilidad](M4-DellInspiron2/Preproduccion.ApiAgendaDirectoriosYDinero/AgendaFarmaciaCotizacionesYContabilidad.md) | [daily](M4-DellInspiron2/M4-DellInspiron2-Daily-Maquinas-2026-09-26.md) | API de agenda, directorios y dinero, sin base | 3 | 14 | `HECHO` (`VERIFIED`) · 14/14 |
| **M5** Laptop Justin | [El build real, el simulador honesto y el enrutado](M5-LaptopJustin/Preproduccion.FrontSalidaDelSimulador/BuildRealMockHonestoYEnrutado.md) | [daily](M5-LaptopJustin/M5-LaptopJustin-Daily-Maquinas-2026-09-26.md) | front: la salida del simulador | 3 | 15 | `HECHO` (15/15) |
...
| M4 | 3/3 (B10, B12, B13) | `VERIFIED` en runtime local sobre base aislada, 21/21 (`docs/progress/evidence/m4-runtime/REPORT.md` de la API) | API **#470 · #471 · #472 → mergeados en `test`** ([#470](https://github.com/mdavila-2001/mantra-core-health-api/pull/470) · [#471](https://github.com/mdavila-2001/mantra-core-health-api/pull/471) · [#472](https://github.com/mdavila-2001/mantra-core-health-api/pull/472)) · arreglo del retiro [#476](https://github.com/mdavila-2001/mantra-core-health-api/pull/476) abierto | ninguna; D-A, D-F y D-G registradas sin resolver; `VERIFIED` pendiente de M1 |
| M5 | 3/3 `HECHO` (H1, H2, H3) | `VERIFIED` los tres | [#711](https://github.com/mdavila-2001/mantra-core-health/pull/711) (mergeado) · [#714](https://github.com/mdavila-2001/mantra-core-health/pull/714) (abierto, mergeable) | Ninguno — H3.S1.M2 se cerró al arrancar Docker Desktop en la máquina y verificar contra nginx + el stack `mantra-redesa` real; encontró y corrigió un bug real (barra final en `/patients/me/reviews` que el verificador estático no veía) |
| M6 | 0/4 | — | — | — |
