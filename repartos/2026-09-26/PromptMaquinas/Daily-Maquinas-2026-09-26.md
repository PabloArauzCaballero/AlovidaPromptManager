...
> **REPARTIDO: 7 / 7 máquinas · 29 hitos · 199 microtareas · 6 requisitos del pedido con dueño.** (M3 agregó 2 a su plan: 197 → 199.)
> **AVANCE: 29 / 199 microtareas — 14,6 %.** ← `microtareas HECHO / total` (M5 14 + M3 15).
> La **Ola 0 ya está ejecutada** y medida (`RUNS`), aparte de esas 95.
> M1 0/22 · M2 0/17 · **M3 15/15** (`TESTED`, PR #473 mergeado en `test`) · M4 0/14 · **M5 14/15** · M6 0/15 · M7 0/101.
