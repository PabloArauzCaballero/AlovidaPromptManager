...
| `dictado.ts` / `dictado.types.ts` | **VERIFIED** | Spec 16/16 contra el doble (3 niveles: correcto, límite, inválido) · prueba real en Chromium (ciclo completo con transcripción real tras H3.S2.M9, Tab+Enter/Espacio) y Firefox (ausencia correcta) |
