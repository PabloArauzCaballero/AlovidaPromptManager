...
- **Gates locales focalizados de #583:** typecheck y build terminaron con exit `0`; el lint de los siete TypeScript del diff terminó con `0`; siete archivos/73 tests y los dos recorridos de navegador de Directorio → Cotizaciones pasaron. El detalle reproducible está en los [gates locales](../../../../docs/trabajo/2026-09-23-publicar-gates-reserva-cotizaciones/REPORTE.md).
