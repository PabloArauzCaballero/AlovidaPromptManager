...
- **Pendiente no técnico local:** baseline histórico hasta cupos, contratos de precios/origen/acciones y suite global. No se inventan ni se marcan HECHO. El DNS de `demo.alovidasalud.com` no se cambia para este cierre.
