# Daily de Itzan — turno noche — 2026-09-22
...
- **Persona:** Itzan · **Turno:** noche · **Fecha:** 2026-09-22 · **Día del plazo:** 4 · **Línea:** A
- **Lote:** [Estabilizar el baseline y probar la migración conjunta](Dia4-BaselineYMigracion.Backend/EstabilizarBaselineYMigracionConjunta.md)
- **Modo:** `SCHEMA_VERIFY` — el esquema cambia por su fuente de verdad, **nunca a mano contra la base**
...
|---|---|---|
| Pablo | Si la deriva reveló algo que su corrección movió | `NO` |
| Justin | El baseline fijado para su relación | `NO` |
| Marcelo | Si el recorrido necesita datos que el baseline todavía no tiene | `NO` |
