...
|---|---|---|---|---|
| ADR-0015 «tabla con acciones» (siete reglas + paginación + scroll) | Pablo, H2.S1 | primera mitad | `docs/adr/ADR-0015-tabla-con-acciones.md` | `TODO` |
| `app-pagination` con Anterior/Siguiente con texto y select de página | Pablo, H3.S1 | primera mitad | | `TODO` |
