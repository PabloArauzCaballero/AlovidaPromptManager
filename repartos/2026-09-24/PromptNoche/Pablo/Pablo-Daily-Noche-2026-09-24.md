# Daily de Pablo — turno noche — 2026-09-24
...
- **Persona:** Pablo · **Turno:** noche · **Fecha:** 2026-09-24 · **Día del plazo:** 6 · **Línea:** A
- **Lote:** [Reparaciones acotadas y nueva verificación de lo afectado](Dia6-ReparacionesAcotadas.Backend/RepararYReverificar.md)
- **Modo:** `FIX_SCOPED` — reparás lo acotado y **reverificás lo que tocaste**
...
|---|---|---|
| Justin | Qué hay que incluir en la regresión del candidato final | `NO` |
| Marcelo | Qué rojo sigue abierto y afecta el dictamen | `NO` |
| Itzan | Si hay que reempaquetar tras las reparaciones | `NO` |
