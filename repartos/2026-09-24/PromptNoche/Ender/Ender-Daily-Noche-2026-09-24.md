# Daily de Ender — turno noche — 2026-09-24
...
- **Persona:** Ender · **Turno:** noche · **Fecha:** 2026-09-24 · **Día del plazo:** 6 · **Línea:** A
- **Lote:** [Cerrar el contrato y dejar sus pendientes con dueño](Dia6-CierreDelContrato.Backend/CerrarElContratoYSusPendientes.md)
- **Modo:** `FREEZE` — cerrás lo cerrable y dejás lo abierto con dueño y fecha
...
|---|---|---|
| Marcelo | Los pendientes que condicionan el dictamen | `NO` |
| Todo el equipo | La versión final del contrato | `NO` |
