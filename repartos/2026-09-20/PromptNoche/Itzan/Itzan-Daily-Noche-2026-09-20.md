...
- **Persona:** Itzan · **Turno:** noche · **Fecha:** 2026-09-20 · **Día del plazo:** 2 · **Línea:** A
- **Lote:** [Demostrar materialmente la ausencia del proveedor](Dia2-PruebaDeAusencia.Backend/DemostrarAusenciaDelProveedor.md)
- **Modo:** `ISOLATE_VERIFY` — trabajás en una **copia descartable**. El checkout original no se toca
...
|---|---|---|
| Todo el equipo | El veredicto: si hoy no hay aislamiento, el Día 3 cambia | `NO` |
| Pablo | Qué import residual bloquea, para priorizarlo mañana | `NO` |
| Marcelo | Si el recorrido elegido sigue siendo alcanzable con esta evidencia | `NO` |
