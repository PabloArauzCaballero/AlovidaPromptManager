...
|---|---|---|
| **Esperás a** | Itzan (componente de acciones y regla de opciones, para tus archivos) | |
| **Te esperan** | **Pablo** (excepción `EXTRA`, motivo del bloqueo, forma de la visita) · **Justin** (clave de la propiedad de frecuencia) · **Marcelo** (dónde guardar las filas de su cuadrícula). **Publicá el contrato antes de terminar la pantalla.** | |
