...
- **Persona:** Pablo · **Turno:** noche · **Fecha:** 2026-09-20 · **Día del plazo:** 2 · **Línea:** A
- **Lote:** [Construir el laboratorio de la capacidad del piloto](Dia2-LaboratorioDelPiloto.Backend/ConstruirElHarnessDeLaCapacidad.md)
- **Modo:** `BUILD_LAB` — construís el laboratorio **fuera** de `src/` de Mantra. Cero cambios en código de producto
...
**0 / 9 microtareas en `HECHO`.** Se calcula, no se estima. Las `A MEDIAS` cuentan como **no hechas**.
...
|---|---|---|
| Itzan | El laboratorio que va a correr dentro de la copia descartable de su prueba de ausencia | `NO` |
| Justin | Qué valida hoy el harness y qué no, para que su doble no asuma de más | `NO` |
| Ender | Qué reglas del contrato el validador no puede comprobar todavía | `NO` |
