...
- **Persona:** Marcelo · **Turno:** noche · **Fecha:** 2026-09-20 · **Día del plazo:** 2 · **Línea:** B
- **Lote:** [Diseñar los casos de aceptación del recorrido y sus datos](Dia2-CasosDelRecorrido.Registro/DisenarCasosYDatosDelRecorrido.md)
- **Modo:** `DESIGN_TESTS` — diseñás los casos; ejecutarlos viene después
...
|---|---|---|
| Justin | Los casos negativos de autorización: van a su matriz | `NO` |
| Ender | Qué reglas del recorrido el contrato todavía no expresa | `NO` |
| Pablo | Qué datos necesita el laboratorio para estos casos | `NO` |
