...
|---|---|---|---:|---:|---:|---|
| **Pablo** | [Corte, laboratorio del piloto y regresión de aislamiento](Pablo/Noche-PilotoDeAvisos.Backend/CorteLaboratorioYRegresion.md) | A | 6 | 18 | 53 | **45/53** — H1, H2, H3, H4 y H5 cerrados; H6 `A MEDIAS` (5 `DESCARTADO`) |
...
**Total del turno: 201 / 262 microtareas** (Pablo 45/53 · Ender 48/50 · Itzan 26/52 · Marcelo 29/54 · Justin 53/53). El avance se reporta `HECHO / total`, **nunca a ojo**.
