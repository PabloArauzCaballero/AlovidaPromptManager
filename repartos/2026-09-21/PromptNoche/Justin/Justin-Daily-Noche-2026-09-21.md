...
- **Persona:** Justin · **Turno:** noche · **Fecha:** 2026-09-21 · **Día del plazo:** 3 · **Línea:** B
- **Lote:** [Integrar la relación con los artefactos que ya estén listos](Dia3-IntegracionPorRelacion.Integracion/IntegrarLaRelacionConLoQueYaEste.md)
- **Modo:** `INTEGRATE` — con participantes reales donde existan; con dobles donde no, **declarándolo**
...
|---|---|---|
| Marcelo | Qué escenarios suyos ya corren con implementaciones reales | `NO` |
| Itzan | Qué necesitó la relación de la composición | `NO` |
| Ender | Qué ambigüedad del contrato apareció al integrar | `NO` |
