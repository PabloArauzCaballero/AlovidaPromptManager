# Daily de Pablo — turno noche — 2026-09-23
...
- **Persona:** Pablo · **Turno:** noche · **Fecha:** 2026-09-23 · **Día del plazo:** 5 · **Línea:** A
- **Lote:** [Regresión de aislamiento y replay del contraejemplo](Dia5-RegresionDeAislamiento.Backend/RegresionYReplay.md)
- **Modo:** `REGRESSION` — corrés en serie, no en paralelo (regla 70.3)
...
|---|---|---|
| Todo el equipo | El estado real de la regresión, incluido el rojo | `NO` |
| Itzan | Qué hay que reempaquetar si algo cambió | `NO` |
| Marcelo | Si la regresión bloquea la aceptación | `NO` |
