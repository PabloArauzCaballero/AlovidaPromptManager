# Daily de Marcelo — turno noche — 2026-09-23
...
- **Persona:** Marcelo · **Turno:** noche · **Fecha:** 2026-09-23 · **Día del plazo:** 5 · **Línea:** B
- **Lote:** [Ejecutar la aceptación del registro con los participantes reales disponibles](Dia5-AceptacionDelRegistro.Registro/EjecutarLaAceptacionConParticipantesReales.md)
- **Modo:** `ACCEPTANCE` — ejecutás la aceptación y reportás lo que da, no lo que conviene
...
|---|---|---|
| Todo el equipo | La matriz de aceptación y los rojos | `NO` |
| Pablo | Las decisiones de alcance que exigen coordinación | `NO` |
| Justin | Qué pasos hay que reejecutar mañana | `NO` |
