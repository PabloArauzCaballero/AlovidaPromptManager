# Daily de Ender — turno noche — 2026-09-23
...
- **Persona:** Ender · **Turno:** noche · **Fecha:** 2026-09-23 · **Día del plazo:** 5 · **Línea:** A
- **Lote:** [Probar que una versión incompatible rompe donde debe y que lo histórico no se toca](Dia5-InmutabilidadDeContratos.Backend/ProbarIncompatibilidadEInmutabilidad.md)
- **Modo:** `VERIFY_CONTRACT` — probás en copia temporal, nunca sobre lo publicado
...
|---|---|---|
| Marcelo | Qué decisión abierta impide firmar la aceptación | `NO` |
| Justin | Contra qué versión corre el candidato compuesto | `NO` |
| Itzan | Si hay que reempaquetar por un cambio de contrato | `NO` |
