...
| D2 · AI service: `glosario.v1` + `/v1/diagnosis/suggest` | **7/8** | `TESTED` (91/91, `docs:check` 0) | [#2](https://github.com/PabloArauzCaballero/AlovidaAIService/pull/2) **mergeado 2026-09-26 01:16 UTC** | Sólo determinista: el camino con modelo va en un 2.º PR (decisión del usuario). Corpus re-pinneado al merge de D1 (`2862369d`) en un PR de seguimiento, contenido idéntico. **Sin despliegue al VPS (sin SSH): el front verá 404 en `/ai/v1/diagnosis/suggest` hasta que alguien corra `deploy/deploy-contabo.sh`** |
